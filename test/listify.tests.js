...
const getText = function () {
  ...
  const source = corpora.texts
  const textObj = source[2]
...
describe('listifier', function () {
  ...
  describe('functional tests', function () {
    const list = newlistifier.getList({ text: getText() })
